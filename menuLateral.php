     <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseProduto"
                    aria-expanded="true" aria-controls="collapseProduto">
                    <i class="fas fa-fw fa-tshirt"></i>
                    <span>Produto</span>
                </a>
                <div id="collapseProduto" class="collapse show" aria-labelledby="headingProduto"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseCaixa"
                    aria-expanded="true" aria-controls="collapseCaixa">
                    <i class="fas fa-fw fa-cash-register"></i></i>
                    <span>Caixa</span>
                </a>
                <div id="collapseCaixa" class="collapse show" aria-labelledby="headingCaixa"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Pagamentos:</h6>
                        <?php
                        require_once $_SERVER['DOCUMENT_ROOT'].'/mkrl/modelo/bo/UsuarioPermissaoBO.php';
                        if(usuarioPermissaoBO::usuarioPossuiPermissao($_SESSION['idUsuarioLogado'], "Cadastrar Caixa")){
                            echo "<a class='collapse-item' href='cadastrarCaixa.php'>Cadastrar</a>";
                        }
                        
                        require_once $_SERVER['DOCUMENT_ROOT'].'/mkrl/modelo/bo/UsuarioPermissaoBO.php';
                        if(UsuarioPermissaoBO::usuarioPossuiPermissao($_SESSION['idUsuarioLogado'], "Listar Caixa")){
                            echo "<a class='collapse-item' href='listarCaixa.php'>Listar</a>";
                        }
                        ?>
