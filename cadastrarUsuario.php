                        ...
                        <div class="card-body">
                            <form method="post" action="control/usuario.php">
                                ...
                                <fieldset>
                                  ...
                                  $lista = UsuarioPermissaoBO::pegarTodasPermissoesDoUsuario($_SESSION['idUsuarioLogado']);
                                  foreach ($lista as $usuarioPermissao){
                                      echo "<input type='checkbox' name='permissao[]'" 
                                          . "value='".$usuarioPermissao->getIdPermissao()."' "
                                      ."id='up'".$usuarioPermissao->getIdPermissao()."'/>";
